...
public class JobFairQueIMP implements IJobFairQue {
    ...
    public JobfairQue getJobFairDetails(Integer jobFairQueId) {
        ...
        if(jobfairQue.isEmpty()){throw new JobFairQueNotFoundById("job details not found by id");}
    ...
    public List<JobfairQue> getAllJobFairDetails( Integer pageNo) {
        ...
        if(jobfairQueList.size()<=0){throw new PageNotFoundException("Page not found");}
...
//        System.out.println("list of de"+listOfCar.size());
        ...
        for(int counter=pageStart,i=1;counter<pageEnd;counter++,i++){
            if(pageStart>jobfairQueList.size()){break;}
...
//        System.out.println(listOfCar);
    ...
    public List<JobfairQue> getJobFairDetailsBySetNo(String setNo, Integer pageNo) {
        ...
        if(jobfairQueList.size()<=0){throw new SetNoNotFoundException("set no not found by id");}
        if(jobfairQueList.size()<=0){throw new PageNotFoundException("Page not found");}
...
//        System.out.println(listOfCar);
    ...
    public List<JobfairQue> getJobFairDetailsBySetNoAndQueType(String setNo,Boolean questionType, Integer pageNo) {
        ...
        if(jobfairQueList.size()<=0){throw new JobFairQuenotFoundByQueTypeAndSetNo("Job Fair Que not Found By Que Type And Set No");}
